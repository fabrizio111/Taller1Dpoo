...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar el pais dado el nombre de una atleta");
	...
	{
		String nombreAtleta= input("Ingrese el nombre del atleta para indicarle cual es su nacionalidad: ");
		String nombre= calculadora.atletaPais(nombreAtleta);
		System.out.println("La nacionalidad del atleta "+ nombreAtleta+ " es "+ nombre);
	}
